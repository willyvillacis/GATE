...
if __name__ == "__main__":
    input_path = r"C:\William\Willy\Doctorado en FIUBA\Tesis\Datos experimentales\Simulación\GATE\EstructuraVGate 9.1\fuente1\output\testCs137_merged.root"
    output_path = r"C:\William\Willy\Doctorado en FIUBA\Tesis\Datos experimentales\Simulación\GATE\EstructuraVGate 9.1\fuente1\output\energia_cuentas.txt"
